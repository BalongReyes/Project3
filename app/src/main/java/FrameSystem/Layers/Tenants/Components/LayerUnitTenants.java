...
public class LayerUnitTenants extends SLayer{

// ==== Constructor ==========================================================================================
    
    public LayerUnitTenants(){
        addLayer();
    }
...
// ==== Static Methods =======================================================================================
    ...
    private static ArrayList<LayerUnitTenants> layeredPanels = new ArrayList<>();
    private static LayerUnitTenants currentLayeredPanel = null;
    
    private static void addLayer(LayerUnitTenants layer){
        layeredPanels.add(layer);
    }
    
    public static LayerUnitTenants getCurrentLayeredPanel(){
        return currentLayeredPanel;
    }
    
    public static void showLayer(LayerUnitTenants showLayer){
        ...
        for(LayerUnitTenants layer : layeredPanels){
