...
// -----------------------------------------------------------------------------------------------------------
    ...
    private void setFocus(){
        this.requestFocus();
        ManagerObjectUnitTenants.changeCurrentObject(this);
    }
...
// Generated =================================================================================================
    ...
    private void initComponents() {
        ...
        move = new FrameSystem.SLibrary.SComponents.SPanel();
        ...
        sLabel3.setText(String.valueOf(data.lastName()));
        ...
        sPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(sPanel4Layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(sLabel3, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        ...
        sPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(sPanel5Layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(sLabel4, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        ...
        sPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(sPanel6Layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(sLabel5, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        ...
        sLabel6.setForeground(new java.awt.Color(70, 70, 70));
        sLabel6.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        sLabel6.setText(String.valueOf(data.mobileNos()));
        ...
        sPanel12Layout.setHorizontalGroup(
            ...
            .addGroup(sPanel12Layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(sLabel6, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        sPanel12Layout.setVerticalGroup(
            ...
            .addGroup(sPanel12Layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(sLabel6, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );

        sPanel1.add(sPanel12);

        sPanel14.setPaintBackground(false);

        sLabel12.setBackground(new java.awt.Color(255, 255, 255));
        sLabel12.setForeground(new java.awt.Color(70, 70, 70));
        sLabel12.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        sLabel12.setText("-");
        ...
        sPanel14Layout.setHorizontalGroup(
            ...
            .addGroup(sPanel14Layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(sLabel12, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        sPanel14Layout.setVerticalGroup(
            ...
            .addGroup(sPanel14Layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(sLabel12, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );

        sPanel1.add(sPanel14);

        sPanel15.setPaintBackground(false);

        sLabel13.setBackground(new java.awt.Color(255, 255, 255));
        sLabel13.setForeground(new java.awt.Color(70, 70, 70));
        sLabel13.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        sLabel13.setText("-");
        ...
        sPanel15Layout.setHorizontalGroup(
            ...
            .addGroup(sPanel15Layout.createSequentialGroup()
                .addGap(6, 6, 6)
                .addComponent(sLabel13, javax.swing.GroupLayout.DEFAULT_SIZE, 77, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );
        sPanel15Layout.setVerticalGroup(
            ...
            .addGroup(sPanel15Layout.createSequentialGroup()
                .addGap(0, 0, 0)
                .addComponent(sLabel13, javax.swing.GroupLayout.DEFAULT_SIZE, 50, Short.MAX_VALUE)
                .addGap(0, 0, 0))
        );

        sPanel1.add(sPanel15);
        ...
        sPanel16.setDefaultBackgroundColor(new java.awt.Color(51, 255, 51));
        sPanel16.setPaintBackground(false);
        sPanel16.setMaximumSize(new java.awt.Dimension(25, 50));
        sPanel16.setMinimumSize(new java.awt.Dimension(25, 50));

        move.setCanHover(true);
        move.setDefaultBackgroundColor(new java.awt.Color(239, 239, 239));
        move.setHoverBackgroundColor(new java.awt.Color(209, 209, 209));
        move.setRadius(10);
        move.setRounded(true);
        move.setPreferredSize(new java.awt.Dimension(25, 25));

        sLabel14.setForeground(new java.awt.Color(255, 255, 255));
        sLabel14.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        sLabel14.setIconSize(11);
        sLabel14.setScaledIcon(new javax.swing.ImageIcon(getClass().getResource("/Icons/modules/moveSmall.png"))); // NOI18N
        ...
        moveLayout.setHorizontalGroup(
            ...
            .addComponent(sLabel14, javax.swing.GroupLayout.DEFAULT_SIZE, 25, Short.MAX_VALUE)
        );
    ...
    private FrameSystem.SLibrary.SComponents.SPanel move;
