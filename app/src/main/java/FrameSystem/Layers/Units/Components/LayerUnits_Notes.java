...
public class LayerUnits_Notes extends SLayer{

// ==== Constructor ==========================================================================================
    
    public LayerUnits_Notes(){
        addLayer();
    }
...
// ==== Static Methods =======================================================================================
    ...
    private static ArrayList<LayerUnits_Notes> layeredPanels = new ArrayList<>();
    private static LayerUnits_Notes currentLayeredPanel = null;
    
    private static void addLayer(LayerUnits_Notes layer){
        layeredPanels.add(layer);
    }
    
    public static LayerUnits_Notes getCurrentLayeredPanel(){
        return currentLayeredPanel;
    }
    
    public static void showLayer(LayerUnits_Notes showLayer){
        ...
        for(LayerUnits_Notes layer : layeredPanels){
